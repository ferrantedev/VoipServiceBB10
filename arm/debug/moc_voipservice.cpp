...
static const char qt_meta_stringdata_VoipService[] = {
    ...
    "readyWrite()\0disconnected()\0"
    "handleInvoke(bb::system::InvokeRequest)\0"
    "onTimeout()\0onIncomingCall()\0onFinished()\0"
    "onSelected(bb::platform::NotificationResult::Type)\0"
};
...
void VoipService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->onIncomingCall(); break;
        case 7: _t->onFinished(); break;
        case 8: _t->onSelected((*reinterpret_cast< bb::platform::NotificationResult::Type(*)>(_a[1]))); break;
        default: ;
        }
    }
}
