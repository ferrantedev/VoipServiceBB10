        ...
        m_invokeManager(new InvokeManager(this))
{
    ...
    m_notify->setTitle("SecuVoip Service");
    m_notify->setBody("SecuVoip service requires attention");

    bb::system::InvokeRequest request;
    request.setTarget("com.example.SecuVoip");
...
{
    if (request.action().compare("com.example.SecuVoipService.RESET") == 0) {
        triggerNotification();
    }
}
